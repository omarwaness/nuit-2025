  ...
  return (
    <main className="min-h-screen flex flex-col items-center bg-slate-50 text-slate-900 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full flex flex-col items-center">
        ...
        <div className="relative w-full bg-gradient-to-r from-emerald-600/90 via-teal-600/90 to-cyan-600/90 text-white pt-36 pb-32 overflow-hidden backdrop-blur-sm">
        ...
        <div className="relative z-20 max-w-6xl mx-auto px-6 -mt-16 mb-24 w-full">
        ...
        <div className="max-w-6xl mx-auto px-6 space-y-24 mb-24 w-full">
