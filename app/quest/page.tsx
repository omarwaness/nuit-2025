  ...
  return (
    <main className="min-h-screen bg-slate-50 text-slate-900 pb-20">
      ...
      <div className="relative bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-600 text-white pt-36 pb-32 overflow-hidden">
        ...
        {/* The "MadBox" Style Curve at the bottom */}
        <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-[0]">
           <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none" className="relative block w-[calc(100%+1.3px)] h-[60px] md:h-[80px] fill-slate-50">
